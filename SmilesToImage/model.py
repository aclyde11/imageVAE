...
class PictureDecoder(nn.Module):
    def __init__(self, rep_size=500):
        ...
        self.conv6 = TranposeConvBlock(64, 32, kernel_size=[5, 40], stride=[1, 1], padding=[1,1])
        self.conv7 = TranposeConvBlock(32, 16, kernel_size=[40, 40], stride=[2, 1], padding=[1,1])
        ...
        self.conv10 = TranposeConvBlock(3, 3, kernel_size=[20, 20], stride=[1, 1,], padding=[1,0])
        self.relu = nn.ReLU()
