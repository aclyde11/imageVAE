...
class PictureDecoder(nn.Module):
    def __init__(self, rep_size=500):
        ...
        self.conv15_ = nn.ConvTranspose2d(128, 128, kernel_size=2, stride=2, padding=1, bias=False)
        ...
        self.conv20 = nn.ConvTranspose2d(32, 32, kernel_size=3, stride=2, padding=2, bias=False)
        self.conv20_ = nn.ConvTranspose2d(32, 32, kernel_size=2, stride=1, padding=2, bias=False)
        self.bn20 = nn.BatchNorm2d(32)
        self.conv17 = nn.ConvTranspose2d(32, 32, kernel_size=4, stride=1, padding=1, bias=False)
        self.conv17_ = nn.ConvTranspose2d(32, 16, kernel_size=5, stride=1, padding=1, bias=False)
        self.bn21 = nn.BatchNorm2d(16)
        self.conv18 = nn.ConvTranspose2d(16, 16, kernel_size=40, stride=1, padding=1, bias=False)
