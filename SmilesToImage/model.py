...
class PixelCNN(nn.Module):
    def __init__(self, nr_resnet=4, nr_filters=40, nr_logistic_mix=6,
...
class PictureDecoder(nn.Module):
    def __init__(self, rep_size=256):
        ...
        self.upper = nn.UpsamplingBilinear2d(size=(40,40))
        self.bn15 = nn.BatchNorm2d(3)
        self.conv16 = nn.ConvTranspose2d(60, 40, kernel_size=3, stride=2, padding=0, bias=False)
        ...
        self.conv17 = nn.ConvTranspose2d(10, 3, kernel_size=4, stride=2, padding=0, bias=False)
