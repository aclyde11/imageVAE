...
class PictureDecoder(nn.Module):
    def __init__(self, rep_size=256):
        ...
        self.conv16 = nn.ConvTranspose2d(16, 16, kernel_size=3, stride=2, padding=1, bias=False)
        self.conv16_ = nn.ConvTranspose2d(16, 16, kernel_size=3, stride=1, padding=1, bias=False)
        self.bn16 = nn.BatchNorm2d(16)
        self.conv20 = nn.ConvTranspose2d(16, 16, kernel_size=4, stride=2, padding=1, bias=False)
        self.conv20_ = nn.ConvTranspose2d(16, 16, kernel_size=4, stride=2, padding=1, bias=False)
        self.conv17 = nn.ConvTranspose2d(16, 16, kernel_size=4, stride=2, padding=1, bias=False)
        self.conv17_ = nn.ConvTranspose2d(16, 16, kernel_size=4, stride=1, padding=0, bias=False)
        self.bn21 = nn.BatchNorm2d(16)
        self.conv18 = nn.ConvTranspose2d(16, 16, kernel_size=4, stride=2, padding=0, bias=False)
    ...
    def forward(self, out):
        ...
        out = self.relu(out)
        out = self.fc4(out)
        out = self.relu(out).view(-1, 16, 8, 8)
