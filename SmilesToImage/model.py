...
class PixelCNN(nn.Module):
    def __init__(self, nr_resnet=3, nr_filters=40, nr_logistic_mix=5,
...
class PictureDecoder(nn.Module):
    def __init__(self, rep_size=256):
        ...
        self.conv15 = nn.ConvTranspose2d(4, 4, kernel_size=2, stride=2, padding=0, bias=False)
        self.conv15_ = nn.ConvTranspose2d(4, 4, kernel_size=3, stride=1, padding=1, bias=False)
        self.bn15 = nn.BatchNorm2d(4)
        self.conv16 = nn.ConvTranspose2d(4, 4, kernel_size=3, stride=2, padding=1, bias=False)
        self.conv16_ = nn.ConvTranspose2d(4, 4, kernel_size=3, stride=1, padding=1, bias=False)
        self.bn16 = nn.BatchNorm2d(4)
        self.conv20 = nn.ConvTranspose2d(4, 4, kernel_size=4, stride=2, padding=1, bias=False)
        self.conv20_ = nn.ConvTranspose2d(4, 4, kernel_size=4, stride=2, padding=1, bias=False)
        self.bn20 = nn.BatchNorm2d(4)
        self.conv17 = nn.ConvTranspose2d(4, 4, kernel_size=4, stride=2, padding=1, bias=False)
        self.conv17_ = nn.ConvTranspose2d(4, 4, kernel_size=4, stride=1, padding=0, bias=False)
        self.bn21 = nn.BatchNorm2d(64)
        self.conv18 = nn.ConvTranspose2d(4, 4, kernel_size=4, stride=2, padding=0, bias=False)
        self.conv18_ = nn.ConvTranspose2d(4, 4, kernel_size=5, stride=1, padding=0, bias=False)
        self.bn22 = nn.BatchNorm2d(4)
        self.conv19 = nn.ConvTranspose2d(4, 3, kernel_size=5, stride=1, padding=0, bias=False)
