...
class PictureDecoder(nn.Module):
    def __init__(self, rep_size=2000):
        ...
        self.conv20_ = nn.ConvTranspose2d(32, 32, kernel_size=4, stride=1, padding=1, bias=False)
        ...
        self.conv18 = nn.ConvTranspose2d(16, 16, kernel_size=40, stride=1, padding=0, bias=False)
