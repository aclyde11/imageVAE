...
class PictureDecoder(nn.Module):
    def __init__(self, rep_size=256):
        ...
        self.conv16 = nn.ConvTranspose2d(50, 40, kernel_size=3, stride=2, padding=1, bias=False)
        self.conv16_ = nn.ConvTranspose2d(40, 30, kernel_size=3, stride=1, padding=1, bias=False)
        self.bn16 = nn.BatchNorm2d(30)
        self.conv20 = nn.ConvTranspose2d(30, 20, kernel_size=4, stride=2, padding=1, bias=False)
        self.conv20_ = nn.ConvTranspose2d(20, 10, kernel_size=4, stride=2, padding=1, bias=False)
        self.bn20 = nn.BatchNorm2d(10)
        self.conv17 = nn.ConvTranspose2d(10, 5, kernel_size=4, stride=2, padding=1, bias=False)
