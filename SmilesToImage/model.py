...
class PictureDecoder(nn.Module):
    def __init__(self, rep_size=256):
        ...
        self.conv20_ = nn.ConvTranspose2d(20, 10, kernel_size=4, stride=2, padding=0, bias=False)
        self.bn20 = nn.BatchNorm2d(10)
        self.conv17 = nn.ConvTranspose2d(10, 5, kernel_size=4, stride=1, padding=0, bias=False)
