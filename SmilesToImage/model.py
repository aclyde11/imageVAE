...
class PictureDecoder(nn.Module):
    def __init__(self, rep_size=500):
        ...
        self.conv20 = nn.ConvTranspose2d(32, 32, kernel_size=3, stride=2, padding=1, bias=False)
        self.conv20_ = nn.ConvTranspose2d(32, 32, kernel_size=2, stride=1, padding=1, bias=False)
