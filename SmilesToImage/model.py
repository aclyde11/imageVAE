...
class PictureDecoder(nn.Module):
    def __init__(self, rep_size=500):
        ...
        self.conv20 = nn.ConvTranspose2d(128, 128, kernel_size=3, stride=2, padding=1, bias=False)
        self.conv20_ = nn.ConvTranspose2d(128, 64, kernel_size=3, stride=2, padding=1, bias=False)
        self.bn20 = nn.BatchNorm2d(64)
        self.conv17 = nn.ConvTranspose2d(64, 64, kernel_size=3, stride=2, padding=1, bias=False)
        ...
        self.conv18_ = nn.ConvTranspose2d(32, 16, kernel_size=7, stride=1, padding=0, bias=False)
        self.bn22 = nn.BatchNorm2d(16)
        self.conv19 = nn.ConvTranspose2d(16, 3, kernel_size=10, stride=1, padding=0, bias=False)
        self.relu = nn.ReLU()
