...
class PictureDecoder(nn.Module):
    def __init__(self, rep_size=500):
        ...
        self.conv4 = TranposeConvBlock(64,  64, kernel_size=[4, 4], stride=[1, 2], padding=[1, 1])
        self.conv5 = TranposeConvBlock(64,  64, kernel_size=[4, 4], stride=[1, 1], padding=[1, 1])
        self.conv6 = TranposeConvBlock(64, 32, kernel_size=[5, 40], stride=[1, 2], padding=[0,0])
        self.conv7 = TranposeConvBlock(32, 16, kernel_size=[40, 40], stride=[1, 2], padding=[0,0])
        self.conv8 = TranposeConvBlock(16, 3, kernel_size=[40, 40], stride=[1, 1], padding=[0,0])
        self.conv9 = TranposeConvBlock(3, 3, kernel_size=[20, 20], stride=[1, 1,], padding=[0,0])
        self.conv10 = TranposeConvBlock(3, 3, kernel_size=[20, 20], stride=[1, 1,], padding=[0,0])
        self.relu = nn.ReLU()
        self.layers = [self.conv1, self.conv2, self.conv3, self.conv4, self.conv5, self.conv6, self.conv7, self.conv8, self.conv9, self.conv10]
