...
class PictureDecoder(nn.Module):
    def __init__(self, rep_size=2000):
        ...
        # Decoder
        self.conv15 = nn.ConvTranspose2d(125, 128, kernel_size=2, stride=2, padding=1,  bias=False)
        self.conv15_ = nn.ConvTranspose2d(128, 64, kernel_size=3, stride=1, padding=1, bias=False)
        self.bn15 = nn.BatchNorm2d(64)
        self.conv16 = nn.ConvTranspose2d(64, 32, kernel_size=4, stride=2, padding=1, bias=False)
        self.conv16_ = nn.ConvTranspose2d(32, 32, kernel_size=3, stride=1, padding=1, bias=False)
        self.bn16 = nn.BatchNorm2d(32)
        self.conv20 = nn.ConvTranspose2d(32, 16, kernel_size=4, stride=2, padding=1, bias=False)
        self.conv20_ = nn.ConvTranspose2d(16, 16, kernel_size=4, stride=1, padding=0, bias=False)
        self.bn20 = nn.BatchNorm2d(16)
        self.conv17 = nn.ConvTranspose2d(16, 8, kernel_size=4, stride=2, padding=1, bias=False)
        self.conv17_ = nn.ConvTranspose2d(8, 6, kernel_size=5, stride=1, padding=0, bias=False)
        self.bn21 = nn.BatchNorm2d(6)
        self.conv18 = nn.ConvTranspose2d(6, 3, kernel_size=40, stride=2, padding=0, bias=False)
        self.conv18_ = nn.ConvTranspose2d(3, 3, kernel_size=40, stride=1, padding=0, bias=False)
