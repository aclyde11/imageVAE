...
#load_state = None
model_load = {'decoder' : '/homes/aclyde11/imageVAE/im_im_small/model/decoder_epoch_106.pt', 'encoder':'/homes/aclyde11/imageVAE/smi_smi/model/encoder_epoch_173.pt'}
#model_load = None
cuda = True
data_size = 1400000
...
train_loader = generate_data_loader(train_root, 128, int(75000))
val_loader = generate_data_loader(val_root, 128, int(10000))
