...
train_data = MoleLoader(
    pd.read_csv("/homes/aclyde11/zinc/train.smi", nrows=2000000, sep=' ', header=None, engine='c', low_memory=False),
    vocab,
    max_len=embedding_width)
val_data = MoleLoader(
    pd.read_csv("/homes/aclyde11/zinc/test.smi", nrows=100000, sep=' ', header=None, engine='c', low_memory=False),
